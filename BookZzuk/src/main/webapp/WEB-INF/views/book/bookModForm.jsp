      ...
      <div class="col-lg-6 col-md-6">
        ...
        <div class="product__details__text">
          <ul>
            ...
            <li><b>할인가격</b><input name="salePrice" value = "${book.salePrice}"></input></li>
            <li><b>설명</b><input name="description" value = "${book.description}"></input></li>
          </ul>
          <button type="submit" class="primary-btn" >수정완료</button>
          <ul>
            <li><b>출판사</b> <input name="publisher" value = "${book.publisher}"></input></li>
            <li>
              <b>카테고리분류</b>
              <input name="category" value = "${book.category}"></input>
            </li>
            <li><b>출판일</b> <input type="date" name="pubDate" value = "${book.pubDate}"></input></li>
